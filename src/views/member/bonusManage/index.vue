<template>
  <div>
    <n-card :bordered="false" class="proCard" title="赠送彩金">
              ...
              >
                ...
                <n-form-item label="操作类型" path="type">
                  <n-radio-group v-model:value="formValue.type" name="type">
                    <n-space>
                      <n-radio value="add">彩金加款</n-radio>
                      <n-radio value="sub">彩金扣款</n-radio>
                    </n-space>
                  </n-radio-group>
                </n-form-item>
...
<script lang="ts" setup>
  ...
  const cacheSearchForm = (username: string) => {
    if (username) {
      ...
      const cacheKey = `bonusManage_search_${adminName}`;
